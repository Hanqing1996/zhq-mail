        ...
        <div class="app-view-wrapper">
            <div class="content app-view app-view-with-footer">
                <header class="hd">
                    ...
                    <div class="user ui-flex align-center" v-if="isLogin">
                        <div class="img">
                            <img :src="userInfo.icon" lazy="loaded">
                        </div>
                        <div class="name">
                    ...
                    <div class="user ui-flex align-center" v-else>
                        <div class="img">
                            <img src="//m.mi.com/static/img/avatar.76a75b8f17.png" lazy="loaded">
                        </div>
                        <router-link :to="{name: 'login',query:{redirect:'/user'}}" class="name" tag="div">
                          登录/注册
                        </router-link>
                    </div>
